<template>
    <div class="column ml-6 p-0">
        ...
        <ApplicationsJobList v-if="select_option_display === 'jobs'" :items="myApplications.applicationJob" @cancelApplicationJob="updateMyApplicationJob($event)"
...
import ApplicationsJobList from './company-list-applicant-jobs.vue';
import myjobApplicationProgramList from './company-list-applicant-program.vue';
