                  ...
                  <div class="columns">
                    <div class="column is-11" @click="viewProgram(program.id)">
                      ...
                      <div class="columns is-multiline ml-6 mt-1">
                        ...
                        <p class="column is-6">ค่าตอบแทน: {{ program.compensation }}</p>
                      </div>
                  </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      let get_programs = [
        { id: 1, company_id: 1, name: "โครงการฝึกอบรม AI", duration: "3 เดือน", category: "เทคโนโลยีสารสนเทศ", location: "กรุงเทพมหานคร", compensation: "ค่าตอบแทน 500 ต่อวัน" },
        { id: 2, company_id: 1, name: "โครงการพัฒนาแอพพลิเคชั่น", duration: "6 เดือน", category: "เทคโนโลยีสารสนเทศ", location: "กรุงเทพมหานคร", compensation: "ค่าตอบแทน 500 ต่อวัน" },
        { id: 3, company_id: 1, name: "โครงการสัมมนา Data Science", duration: "1 สัปดาห์", category: "วิทยาศาสตร์ข้อมูล", location: "กรุงเทพมหานคร", compensation: "ค่าตอบแทน 500 ต่อวัน" },
      ]
